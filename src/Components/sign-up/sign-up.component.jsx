...
class SignUp extends React.Component {
  ...
  render() {
    ...
    return (
      ...
      <FormInput type='text' name='displayName' value={displayName} label='name' onChange={this.handleChange} required></FormInput>
      ...
      <FormInput type='password' name='confirmPassword' value={confirmPassword} label='confirmPassword' onChange={this.handleChange} required></FormInput>
